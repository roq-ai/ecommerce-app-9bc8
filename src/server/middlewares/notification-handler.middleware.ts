...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderCreated.create': { roles: ['business-owner', 'team-member'], key: 'orderId', tenantPath: [], userPath: [] },
  ...
  'LowInventory.update': { roles: ['business-owner'], key: 'inventoryId', tenantPath: [], userPath: [] },
};
