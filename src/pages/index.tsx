  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Ecommerce app: Streamlining Your Online Business Operations with Robust Backend Services for an Unmatched Shopping Experience"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1563013544-824ae1b704d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2V8ZW58MHx8fHwxNjk1MjUxODY4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Ecommerce app: Streamlining Your Online Business Operations with Robust Backend Services for an Unmatched Shopping Experience`}
            </Text>
            <Box
